...
INSERT INTO "new_Salary" ("basePay", "createdAt", "cycleEnd", "cycleStart", "grossPay", "id", "issuedAt", "netPay", "otPay", "paymentProof", "signature", "status", "totalAdvance", "totalExpense", "totalPaid", "unpaidBalance", "updatedAt", "workerId") SELECT "basePay", "createdAt", "cycleEnd", "cycleStart", "grossPay", "id", "issuedAt", "netPay", "otPay", "paymentProof", "signature", "status", "totalAdvance", "totalExpense", "totalPaid", "unpaidBalance", "updatedAt", "workerId" FROM "Salary";
DROP TABLE "Salary";
